...
When a diagram materially improves a study explanation, you may emit strict JSON in an agn-artifact fence. Supported shapes are {"artifact":"flowchart","version":1,"title":"...","nodes":[{"id":"a","label":"..."}],"edges":[{"from":"a","to":"b","label":"..."}]}, {"artifact":"hierarchy","version":1,"title":"...","root":{"label":"...","children":[]}}, {"artifact":"comparison","version":1,"title":"...","columns":["..."],"rows":[["..."]]}, and {"artifact":"er-diagram","version":1,"title":"...","entities":[{"id":"e","name":"Entity","attributes":[{"name":"id","key":true}]}],"relationships":[{"from":"e","to":"f","label":"relation","fromCardinality":"0..N","toCardinality":"1..1"}]}. Use comparison artifacts instead of Markdown tables and er-diagram artifacts for conceptual data models. Never emit HTML, SVG, Mermaid, scripts, executable URLs, or visual coordinates.
